...
"=="   { return new_symbol(sym.L_EQUAL, yytext()); }
"!="   { return new_symbol(sym.L_NEQUAL, yytext()); }
">"   { return new_symbol(sym.GREATER, yytext()); }
">="   { return new_symbol(sym.GR_EQU, yytext()); }
"<"   { return new_symbol(sym.LESSER, yytext()); }
"<="   { return new_symbol(sym.LE_EQU, yytext()); }
...
"\"".*"\"" { return new_symbol(sym.STR_CONST, new String (yytext().substring(1, yytext().length()-1))); }
"true"|"false" {return new_symbol (sym.BOOL_CONST, yytext()); }
([a-z]|[A-Z])[a-z|A-Z|0-9|_]* 	{return new_symbol (sym.IDENT, yytext()); }
\'[A-Za-z0-9_]\' {return new_symbol (sym.CHAR_CONST, yycharat(1)); }
